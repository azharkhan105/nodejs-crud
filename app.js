...
var add_new_passwordRouter = require('./routes/add-new-password');
var allPasswordRouter = require('./routes/view-all-password');
...
app.use('/add-new-category', add_new_categoryRouter);
app.use('/passwordCategory', passwordCategoryRouter);
app.use('/add-new-password', add_new_passwordRouter);
app.use('/view-all-password', allPasswordRouter);
